      ...
      <section className="section section-dark">
        <div className="container">
          <div className="section-header center">
            ...
            <p className="section-desc">In collaboration with local and international partners, we address food insecurity, climate change, over-fishing, gender inequality, urbanization, and poverty.</p>
          </div>
      ...
      <section className="section section-light">
        <div className="container">
          <div className="spotlight-grid">
            <img
              src="/images/mangrove-sunrise.jpg"
              alt="Mangrove Restoration, Western Region"
              style={{ borderRadius: 'var(--radius-lg)', width: '100%', aspectRatio: '4/3', objectFit: 'cover' }}
            />
            <div>
              <span className="section-label">In the Spotlight</span>
              <h2 style={{ fontFamily: 'var(--font-heading)', fontSize: '1.8rem', lineHeight: 1.25, marginBottom: 'var(--spacing-md)' }}>Clam Depuration &amp; Community-Led Conservation</h2>
              <p style={{ color: 'var(--color-gray-600)', lineHeight: 1.8, marginBottom: 'var(--spacing-lg)' }}>
                Hɛn Mpoano&apos;s clam depuration technology — one of the first in West Africa — has gained Ministerial attention. Meanwhile, our community-led mangrove restoration and MPA declaration work continues to make headlines.
              </p>
              <p style={{ color: 'var(--color-gray-600)', lineHeight: 1.8, marginBottom: 'var(--spacing-lg)' }}>
                From Takoradi to Ada, we work alongside fishing communities, government agencies, and international partners to build a sustainable future for Ghana&apos;s coast.
              </p>
              <a href="https://henmpoano.org/hen-mpoanos-novel-clam-depuration-technology-gains-ministerial-attention-in-ada/" className="btn btn-sand" target="_blank" rel="noopener">Read the Full Story →</a>
            </div>
          </div>
        </div>
      </section>
